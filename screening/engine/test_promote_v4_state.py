...
def bundle():
    ...
    cert_body={"schema_version":"2.0.0","kind":p.CERT_KIND,"architecture_version":"4.1.0","master_content_sha256":content_sha,"market_session_id":"2026-08-18","candidate_source_identity":source["candidate_source_identity"],"candidate_source_sha256":source["source_sha256"],"eligible_universe_size":4000,"quality_candidate_union_size":500,"lane_counts":{"established_quality":500},"selector_model_version":"fixture","selector_config_sha256":"c"*64,"fact_coverage":{"minimum_pct":40,"eligible_scope_count":500},"current_recovery_used":False,"forbidden_recovery_fields":[],"issuer_dedup":{"enabled":True,"stats":{}},"requested_size":500,"selected_scope_count":500,"cohort_scope_keys_sha256":p.sem([x["research_scope_key"] for x in scopes]),"deterministic_ordering_model":"fixture","cutoff_diagnostics":{},"regression_expectations":[],"regression_expectations_satisfied":True}
