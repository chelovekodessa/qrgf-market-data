...
def build() -> dict[str, Any]:
    ...
    analytical=[x for x in files if x["path"] in {
        "config/policy.json","config/connectors.json","config/approved-etfs.csv","scripts/provenance.py","scripts/bootstrap.py","scripts/bootstrap_state.py","scripts/orchestration.py","scripts/deployment.py","scripts/factpack.py","scripts/passport.py","scripts/research.py","scripts/selection.py","scripts/evidence.py","scripts/eligibility.py","scripts/registry.py","scripts/registry_store.py","scripts/campaign.py","scripts/migration.py","scripts/market_view.py","scripts/cli.py","scripts/decision.py","scripts/technical.py","scripts/recovery.py"
